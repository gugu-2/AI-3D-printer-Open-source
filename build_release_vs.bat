@REM QuantumForge build script for Windows with VS auto-detect
@echo off
set WP=%CD%
...
if "%1"=="pack" (
    ...
    echo packing deps: QuantumForge_dep_win64_!build_date!_vs!VS_VERSION!.zip

    %WP%/tools/7z.exe a QuantumForge_dep_win64_!build_date!_vs!VS_VERSION!.zip QuantumForge_dep
    goto :done
)
...
set "INSTALL_DIR=%WP%\%build_dir%\QuantumForge"
set "HOST_RUNTIME_DIR=%WP%\tools\pjarczak_bambu_linux_host\runtime\linux-x86_64"
