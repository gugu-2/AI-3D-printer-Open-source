...
namespace {
constexpr const char* ORCA_DEFAULT_API_URL = "https://xxx.quantumforge.com";
constexpr const char* ORCA_DEFAULT_AUTH_URL = "https://xxx.quantumforge.com";
...
constexpr const char* SECRET_STORE_SERVICE = "QuantumForge/Auth";
...
std::string generate_uuid(const std::string& name = "")
{
    ...
    // Use a fixed namespace UUID for QuantumForge profiles
