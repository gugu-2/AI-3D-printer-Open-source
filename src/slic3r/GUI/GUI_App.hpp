...
enum QuantumForgeMenuIDs {
  QuantumForgeMenuAbout,
  QuantumForgeMenuPreferences,
};
...
public:
    ...
    std::string logo_name() const { return is_editor() ? "QuantumForge" : "QuantumForge-gcodeviewer"; }
