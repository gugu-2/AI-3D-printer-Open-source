...
void Sidebar::priv::layout_printer(bool isBBL, bool isDual)
{
    ...
    // ref: https://github.com/QuantumForge/QuantumForge/pull/11610#discussion_r2607411847
                ...
                En3mfType          en_3mf_file_type = En3mfType::From_BBS;
                {
                    ...
                    if (en_3mf_file_type == En3mfType::From_Prusa) {
                        ...
                        if(load_type != LoadType::LoadGeometry)
                            show_info(q, _L("The 3MF is not supported by QuantumForge, loading geometry data only."), _L("Load 3MF"));
                    }
                    ...
                    //             show_info(q, _L("The 3MF was generated by an old QuantumForge, loading geometry data only."), _L("Load 3MF"));
                    //         else
                    //             show_info(q, _L("The 3MF is not supported by QuantumForge, loading geometry data only."), _L("Load 3MF"));
                    //     }
                    ...
                    //     }
                    // }
                    // Orca: check if the project is created with QuantumForge 2.3.1-alpha and use the sparse infill rotation template for non-safe infill patterns
                        ...
                        if (!config_loaded.opt_string("sparse_infill_rotate_template").empty()) {
                            ...
                            if (!is_safe_to_rotate) {
                                wxString msg_text = _(
                                    L("This project was created with an QuantumForge 2.3.1-alpha and uses "
                                ...
                                msg_text += "\n\n" +
                                            _(L("Would you like QuantumForge to automatically fix this by clearing the rotation template settings?"));
                        ...
                        load_config = false;
                        show_info(q, _L("The 3MF file was generated by an old QuantumForge version, loading geometry data only."), _L("Load 3MF"));
                    }
                    else if (!load_config) {
...
#else
    wxGetApp().mainframe->SetTitle(m_project_name + " - QuantumForge");
...
void Plater::priv::update_title_dirty_status()
{
    ...
    wxGetApp().mainframe->update_title_colour_after_set_title();
#else
    wxGetApp().mainframe->SetTitle(title + " - QuantumForge");
    ...
    , m_action(2)
{
    ...
    // icon
    std::string icon_path = (boost::format("%1%/images/QuantumForgeTitle.ico") % resources_dir()).str();
    ...
    if (type == PrinterWarningType::NOT_CONNECTED) {
        if (device_page) {
            ...
            content = wxString::Format(
                _L("QuantumForge can't connect to %s. Please check if the printer is powered on and connected to the network."), printer_name);
        }
