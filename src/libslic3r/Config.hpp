...
// When parsing a configuration value, if the old_value is not understood by this QuantumForge version,
// it is being substituted with some default value that this QuantumForge could work with.
