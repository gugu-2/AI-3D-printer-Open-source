...
#define GCODEVIEWER_APP_NAME "QuantumForge G-code Viewer"
#define GCODEVIEWER_APP_KEY  "QuantumForgeGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("QuantumForge G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
