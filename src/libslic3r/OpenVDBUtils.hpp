...
// Apply a material gradient across a grid, representing a blending of two materials.
// Value will map to 0.0 - 1.0 depending on position (mock voxel-based multi-material gradient).
