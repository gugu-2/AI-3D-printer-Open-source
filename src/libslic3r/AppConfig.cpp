...
static const std::string VERSION_CHECK_URL = "https://check-version.quantumforge.com/latest";
static const std::string PROFILE_UPDATE_URL = "https://api.github.com/repos/QuantumForge/quantumforge-profiles/releases/tags";
